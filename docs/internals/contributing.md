...
الأولى تختبر اللغة والأمثلة وقواعد التلوين. والثانية تُلزم المترجِم والآلة الافتراضية
بمطابقة المُفسِّر الشجري حرفًا بحرف: تُعيد الاختبارات الأولى على الآلة، وتشغّل كل
مثال في التوثيق وبرامج `tests/differential_cases.py` الصعبة في المحرّكين وتقارن.
والثالثة تختبر **التوثيق**: كل كتلة شيفرة فيه تُحلَّل، وكل كتلة ناتج تُقارَن بتشغيل
الشيفرة التي فوقها، وكل دالة مدمجة وكلمة مفتاحية وتابع وتعليمة بايت-كود موثَّقة.
تعمل كلها بـ`pytest` أيضًا.

ولقياس السرعة بعد أي تعديل على الآلة:
